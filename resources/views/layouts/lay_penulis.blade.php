...
<head>
    ...
    <link rel="stylesheet"
        href="/assets/AdminLTE-master/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper" id="app">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="/assets/AdminLTE-master/dist/img/AdminLTELogo.png" alt="AdminLTELogo"
                height="60" width="60">
        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/assets/AdminLTE-master/dist/img/user1-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/assets/AdminLTE-master/dist/img/user8-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/assets/AdminLTE-master/dist/img/user3-128x128.jpg" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="/assets/AdminLTE-master/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="/assets/AdminLTE-master/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="/index" class="nav-link  @yield('menu_artikel')">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./tulis-artikel" class="nav-link  @yield('menu_tulis_artikel')">
                                ...
                                <li class="nav-item">
                                    <a href="/semua-artikel" class="nav-link @yield('menu_semua_Artikel')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Semua Artikel</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="/publish" class="nav-link  @yield('menu_publish')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Publish</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/draft" class=" nav-link @yield('menu_draft')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Draft</p>
                                    </a>
                                </li>
                        ...
                        {{-- Kategori --}}
                        <li class="nav-item menu-open">
                            <a href="/index" class="nav-link  @yield('menu_kategori')">
                                <i class="nav-icon fas fa-cat"></i>
                                <p>
                                    Kategori
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/kategori" class="nav-link @yield('menu_sub_kategori')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Kategori</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="/semua-kategori" class="nav-link @yield('menu_semua_kategori')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Semua Kategori</p>
                                    </a>
                                </li>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Home v1</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
